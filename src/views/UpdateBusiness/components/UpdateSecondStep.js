      ...
      <Grid container spacing={2}>
        <Grid item xs={12}>
          ...
          <Checkbox
            ...
            checked = {(JSON.parse(filteredPerson.dayOpen)).sunday}
          ...
          <Checkbox 
            ...
            checked = {(JSON.parse(filteredPerson.dayOpen)).monday}
          ...
          <Checkbox 
            ...
            checked = {(JSON.parse(filteredPerson.dayOpen)).tuesday}
          ...
          <Checkbox 
            ...
            checked = {(JSON.parse(filteredPerson.dayOpen)).wednesday}
          ...
          <Checkbox 
            ...
            checked = {(JSON.parse(filteredPerson.dayOpen)).thursday}
          ...
          <Checkbox 
            ...
            checked = {(JSON.parse(filteredPerson.dayOpen)).friday}
          ...
          <Checkbox 
            ...
            checked = {(JSON.parse(filteredPerson.dayOpen)).saturday}
