...
const Hero = props => {
  ...
  if (appointmentData[0] != null) {
    if (appointmentData.filter((item) => {
                      ...
                      <Card className={classes.root}>
                        <CardContent>
                          ...
                          <Typography gutterBottom component="h2" className={classes.content}>
                            Date: {moment(item.dateTime).format('MMM DD, YYYY')}
                          </Typography>
                          <Typography gutterBottom component="h2" className={classes.content}>
      ...
      return (
        <div>
          <Typography className={classes.centered} onClick={bookAppointment}>
            It looks like you have no active appointments at the moment, click here to book an appointment.
          </Typography>
        </div>
      )
    }
